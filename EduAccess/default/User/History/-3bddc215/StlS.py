...
class Classes (models.Model):
    ...
    ###performance = models. (should add functionality for one to see class performance blockwise stream wise)
...
class Students (models.Model):
    ...
    parent = models.OneToOneField(Parents, on_delete=models.SET_NULL, related_name='children')
